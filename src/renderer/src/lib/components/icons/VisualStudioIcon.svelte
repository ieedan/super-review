...
>
  <defs>
    <path id="visual_studio-reuse-0" fill="#fff" d="M8.271 8.271h176.457v176.457H8.271z" />
  </defs>
  <g clip-path="url(#visual_studio-a)">
    <g clip-path="url(#visual_studio-b)">
      <mask
        id="visual_studio-c"
        width="177"
        height="177"
      ...
      <g mask="url(#visual_studio-c)">
        ...
        />
        <g filter="url(#visual_studio-d)">
          <path
            fill="url(#visual_studio-e)"
        ...
        <g filter="url(#visual_studio-f)">
          <path
            fill="url(#visual_studio-g)"
        ...
        <g filter="url(#visual_studio-h)">
          <path
            fill="url(#visual_studio-i)"
  ...
  <defs>
    ...
    <clipPath id="visual_studio-a"><use xlink:href="#visual_studio-reuse-0" /></clipPath>
    <clipPath id="visual_studio-b"><use xlink:href="#visual_studio-reuse-0" /></clipPath>
  </defs>
</svg>
