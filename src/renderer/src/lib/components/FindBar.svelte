...
{#if find.open}
  ...
  <div
    class="pointer-events-auto absolute right-3 top-2 z-20 flex items-center gap-1 rounded-lg border border-border bg-card/95 p-1 shadow-lg backdrop-blur"
    role="search"
  >
    <input
      bind:this={inputEl}
