	...
	>
		...
		<div
			...
			class={cn(
				...
				animations.animationsEnabled && "transition-[width] duration-200 ease-linear",
		...
		<div
			...
			class={cn(
				...
				animations.animationsEnabled && "transition-[left,right,width] duration-200 ease-linear",
				side === "left"
