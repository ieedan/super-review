<script lang="ts">
	// Settings → Skills: the skill and subagent files installed for the coding
	// agents, per scope (this project / your home directory). Installing is the
	// Configure wizard's job; this panel lists what is there, offers an update when
	// the bundled copy is newer, and can delete a file from disk.
