<script lang="ts">
	...
	import { authorInitials, cn, isEditableTarget, formatRelative } from '@super-review/ui/utils';
	import {
		commitAuthorLabel,
		commitAvatarUrl,
		ensureAvatars
	} from '@super-review/ui/commit-identity.svelte';
	...
	import { tourFileOrder } from '@super-review/ui/session-tour';
