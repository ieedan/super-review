<script lang="ts" module>
	...
	import type { ButtonProps as ButtonPrimitiveProps } from '@super-review/ui/components/ui/button';
	...
	export { type ButtonSize, type ButtonVariant } from '@super-review/ui/components/ui/button';
</script>
