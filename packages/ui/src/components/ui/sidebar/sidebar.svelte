<script lang="ts">
	import * as Sheet from '@super-review/ui/components/ui/sheet/index.js';
	...
	>
		...
		<div
			...
			class={cn(
				...
				animations.accentsEnabled && 'transition-[width] duration-200 ease-linear',
		...
		<div
			...
			class={cn(
				...
				animations.accentsEnabled && 'transition-[left,right,width] duration-200 ease-linear',
				side === 'left'
